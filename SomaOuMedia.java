...
public class SomaOuMedia {
    ...
    public static void main(String[] args) { 
        ...
        /* Professor, se já fosse possível eu deixaria essa leitura para uma outra classe
         * e a chamaria dentro de cada case. Deixei aqui para o código não ficar cheio de
         * repetição. Mas tenho consciência que deixando aqui retarda um pouco a mensagem
         * de erro para o usuário caso ele faça a escolha de case errada.
        */
